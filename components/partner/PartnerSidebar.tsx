...
const nav = [
  ...
  { href: '/partner/clients', label: 'My Clients', icon: '👥' },
  { href: '/partner/commissions', label: 'Commissions', icon: '💰' },
  { href: '/partner/referrals', label: 'Referral Link', icon: '🔗' },
  ...
  return (
    <aside className="w-64 bg-gray-900 text-white min-h-screen flex flex-col">
      <div className="p-6 border-b border-gray-800">
        <div className="text-lg font-bold text-brand-400">Partner Portal</div>
